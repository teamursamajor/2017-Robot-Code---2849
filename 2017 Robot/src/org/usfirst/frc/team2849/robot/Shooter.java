...
public class Shooter {
	private static final double SHOOTERSPEED = 1.0;// change this to change how
													// fast shooter goes
	// Hopper
	/*
	...
	// Shooter
	/*
	 * 1. start motor 3. stop motor after shooting is complete
	 */
	...
	public static void killShooter() {// call this from controller to stop
										// firing early
	...
	public static void shoot(double axis) {// call this from controller to begin
											// firing

		/*
		 * if(axis > 0){ shooterWheel1.set(1.0); shooterWheel2.set(-1.0); }else{
		 * shooterWheel1.set(0); shooterWheel2.set(0); }
		 */
	...
	public static void shoot(boolean button) {// call this from controller to
												// begin firing
		/*
		 * if(button&keepShooting()){ shooterWheel1.set(1.0);
		 * shooterWheel2.set(-1.0); }else{ shooterWheel1.set(0);
		 * shooterWheel2.set(0); }
		 */
		if (button) {
			newcase = 0;// lever not down, end shooting
